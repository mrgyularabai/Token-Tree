...
namespace Ozeki
{
    public abstract class OzAIIntVec : OzAIVector
    {
        ...
        public override bool GetProcMode(out OzAIProcMode mode, out string error)
        {
            if (_procMode == null)
            {
                error = "Could not get processing mode, because OzAIIntVec not created with 'Create'.";
                mode = null;
                return false;
            }
        ...
        public static bool Create(OzAIProcMode mode, out OzAIIntVec res, out string error)
        {
            res = null;
        ...
        public abstract bool SetNthInt(int res, ulong index, out string error);
        public abstract bool GetNthInt(ulong index, out int res, out string error);
    }
}
